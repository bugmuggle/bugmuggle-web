            ...
            <UButton
              ...
              color="white"
              variant="soft"
              class="absolute right-0 top-1/2 -translate-y-1/2 shadow-md"
              @click="scrollRight"
            />
          </div>
          <UInput
  ...
  <div class="space-y-3">
    ...
    <div v-if="task" class="px-3 space-y-3">
      ...
      <div class="px-4 space-y-1 mt-4">
        ...
        <div class="space-y-2">
          <div class="relative">
            <div class="flex items-center overflow-x-auto gap-3" ref="attachmentsContainer">
              <div 
...
// Check for horizontal scroll when attachments change
watch(attachments, () => {
  nextTick(() => {
...
// Check for horizontal scroll on window resize
onMounted(() => {
...
// Check for horizontal scroll after initial fetch
watch(() => attachments.value.length, () => {
  nextTick(() => {
    checkForHorizontalScroll()
  })
})
